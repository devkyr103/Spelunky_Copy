...
namespace renderer
{
	...
	void LoadBuffer()
	{
		...
		kyr::graphics::GetDevice()->CreateBuffer(&triangleBuffer, &triangleDesc, &triangleData);
		...
		kyr::graphics::GetDevice()->CreateBuffer(&triangleIdxBuffer, &triangleIdxDesc, &triangleIdxData);
	...
	void LoadShader()
	{
		kyr::graphics::GetDevice()->CreateShader();
	}
